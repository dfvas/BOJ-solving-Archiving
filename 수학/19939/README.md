...
 <p>1. N개의 공을 K개의 바구니에 빠짐없이 나누어 담는다.</p>
<p>2. 각 바구니에는 1개 이상의 공이 들어 있어야 한다.</p>
<p>3. 각 바구니에 담긴 공의 개수는 모두 달라야 한다.</p>
<p>4. 가장 많이 담긴 바구니와 가장 적게 담긴 바구니의 공의 개수 차이가 최소가 되어야 한다.</p>
...
### 출력 
 ...
 <p>N개의 공을 K개의 바구니에 문제의 규칙을 만족하면서 나눠 담을 수 있다면, 가장 많이 담긴 바구니와 가장 적게 담긴 바구니의 공의 개수 차이를 출력한다. 나눠 담을 수 없는 경우에는 -1을 출력한다.</p>
